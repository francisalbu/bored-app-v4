  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      if (paymentMethod === 'apple_pay' && Platform.OS === 'ios') {
        sheetOptions.applePay = { merchantCountryCode: 'PT' };
      } else if (paymentMethod === 'google_pay' && Platform.OS === 'android') {
        sheetOptions.googlePay = {
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.securityText}>🔒 All payments are encrypted and secure</Text>
          ...
          {Platform.OS === 'android' && (
            ...
            >
              <View style={styles.paymentOptionContent}>
                ...
                <Text style={styles.iconText}>G Pay</Text>
              </View>
            </Pressable>
          )}
          ...
          >
            <View style={styles.paymentOptionContent}>
              ...
              <CreditCard size={20} color={colors.dark.textSecondary} />
            </View>
          </Pressable>
        </View>
      ...
      <View style={[styles.bottomBar, { paddingBottom: Math.max(insets.bottom, 16) }]}>
        <Pressable 
          style={[
            ...
            (!paymentMethod || isProcessing) && styles.confirmButtonDisabled
          ]} 
          ...
          {isProcessing ? (
            ...
            <View style={styles.buttonRow}>
              ...
              <Text style={[styles.confirmButtonText, { marginLeft: 10 }]}>
                {paymentMethod ? 'Confirm and pay' : 'Select payment method'}
              </Text>
            </View>
          )}
        </Pressable>
